...
function ChaseInfoContent() {
  return (
    <div className="space-y-3 text-sm text-textSecondary">
      <p>
        Chase is trained on the philosophies of coaches like{' '}
        <span className="text-primary font-medium">Daniels</span>,{' '}
        <span className="text-primary font-medium">Pfitzinger</span>,{' '}
        <span className="text-primary font-medium">Lydiard</span>,{' '}
        <span className="text-primary font-medium">Hansons</span>, and{' '}
        <span className="text-primary font-medium">Canova</span> — plus modern sports science on
        periodization, recovery, and pacing.
      </p>
      <p>
        His workout library has <span className="text-primary font-medium">40+ templates</span>{' '}
        across 12 types — tempos, progressions, fartleks, intervals, threshold work, and more.
        Every prescription is calibrated to your fitness, your goals, and how you&apos;re feeling today.
      </p>
      <p>
        He listens to your feedback, tracks your trends, and adapts your plan daily. Ask him
        anything — log a run, get a workout, adjust your plan, or just talk training.
      </p>
      <Link
        href="/coach/guide"
        ...
        <div className="mb-4 p-4 bg-surface-1 rounded-xl border border-borderPrimary animate-in slide-in-from-top-2 fade-in duration-200">
          <div className="flex items-start justify-between mb-3">
            <div className="flex items-center gap-2">
              <div className="w-8 h-8 rounded-full bg-gradient-to-br from-dream-500 to-dream-700 flex items-center justify-center">
        ...
        <>
          ...
          <div className="fixed inset-x-4 top-1/2 -translate-y-1/2 z-50 max-w-md mx-auto bg-bgSecondary rounded-2xl border border-borderPrimary shadow-2xl p-6 animate-in zoom-in-95 fade-in duration-300">
            <div className="text-center mb-5">
              <div className="w-16 h-16 rounded-full bg-gradient-to-br from-dream-500 to-dream-700 flex items-center justify-center mx-auto mb-3">
