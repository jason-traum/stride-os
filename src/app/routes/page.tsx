...
function RouteCard({ route }: { route: RouteWithStats }) {
  ...
  return (
    <Link
      ...
      className="bg-surface-1 rounded-xl border border-default p-5 hover:border-teal-300 hover:shadow-md transition-all group"
    >
      {/* Header */}
      <div className="flex items-start justify-between mb-4">
        <div>
          <h3 className="font-semibold text-primary group-hover:text-teal-600 transition-colors">
            {route.name}
          </h3>
        ...
        <ChevronRight className="w-5 h-5 text-tertiary group-hover:text-teal-500 transition-colors" />
      </div>
