  ...
  return (
    <div className="min-h-screen bg-stone-50 py-8">
      <div className="max-w-4xl mx-auto px-4">
        <h1 className="text-3xl font-bold text-stone-900 mb-8">Complete Strava Setup Guide</h1>
        ...
        {activeTab === 'manual' ? (
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl border border-stone-200 p-6 shadow-sm">
              ...
              <p className="text-stone-600 mb-4">Go to <a href="https://www.strava.com/settings/api" target="_blank" className="text-[#FC4C02] font-medium">strava.com/settings/api</a> and fill in:</p>

              <div className="space-y-4 bg-stone-50 p-4 rounded-lg">
                <div>
                  <label className="text-sm font-medium text-stone-700">Application Name:</label>
                  <p className="font-mono text-sm bg-white px-2 py-1 rounded mt-1">Dreamy Running Tracker</p>
                </div>
                <div>
                  <label className="text-sm font-medium text-stone-700">Category:</label>
                  <p className="font-mono text-sm bg-white px-2 py-1 rounded mt-1">Training</p>
                </div>
                <div>
                  <label className="text-sm font-medium text-stone-700">Club:</label>
                  <p className="font-mono text-sm bg-white px-2 py-1 rounded mt-1">(leave empty or choose any)</p>
                </div>
                <div>
                  <label className="text-sm font-medium text-stone-700">Website:</label>
                  <p className="font-mono text-sm bg-white px-2 py-1 rounded mt-1">https://getdreamy.run</p>
                </div>
                <div>
                  <label className="text-sm font-medium text-stone-700">Authorization Callback Domain:</label>
                  <p className="font-mono text-sm bg-white px-2 py-1 rounded mt-1">localhost:3005</p>
                  <p className="text-xs text-stone-500 mt-1">(Add more domains separated by commas if needed)</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl border border-stone-200 p-6 shadow-sm">
              ...
              <p className="text-stone-600 mb-4">Visit this URL in your browser (replace CLIENT_ID with your ID):</p>
            ...
            <div className="bg-white rounded-xl border border-stone-200 p-6 shadow-sm">
              ...
              <p className="text-stone-600 mb-4">Run this command with your authorization code:</p>
...
{`curl -X POST https://www.strava.com/oauth/token \\
  ...
  -d grant_type=authorization_code`}
              ...
              <p className="text-sm text-stone-600 mt-4">This will return JSON with:</p>
    ...
    ...
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 border border-stone-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#FC4C02]"
                  />
                </div>
                <div>
                ...
                <div>
                  <label className="block text-sm font-medium text-stone-700 mb-1">Athlete ID</label>
                  <input
                    type="text"
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl border border-stone-200 p-6 shadow-sm">
              ...
              <div className="space-y-6">
                <div>
                  <h3 className="font-medium text-stone-800 mb-2">1. Configure Strava App</h3>
                  <p className="text-stone-600 mb-2">At <a href="https://www.strava.com/settings/api" target="_blank" className="text-[#FC4C02] font-medium">strava.com/settings/api</a>:</p>
                ...
                <div>
                  <h3 className="font-medium text-stone-800 mb-2">2. Environment Variables</h3>
                  <p className="text-stone-600 mb-2">Your app needs these in <code className="bg-stone-100 px-1">.env.local</code>:</p>
...
STRAVA_CLIENT_SECRET=283960e6891f39efe455144ff9b632e9cc98cf20`}
                ...
                <div>
                  <h3 className="font-medium text-stone-800 mb-2">3. Connect Flow</h3>
                ...
                <div>
                  <h3 className="font-medium text-stone-800 mb-2">4. Testing Connection</h3>
                  <p className="text-stone-600 mb-2">After connecting:</p>
        ...
        <div className="mt-8 p-4 bg-stone-100 rounded-lg">
          <h3 className="font-medium text-stone-800 mb-2">Quick Links</h3>
