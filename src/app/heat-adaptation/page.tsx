    ...
    <div className="min-h-screen bg-stone-50">
      <div className="mx-auto max-w-4xl p-4 sm:p-6">
        ...
        <div className="mb-6">
          ...
          <h1 className="text-3xl font-bold text-stone-900 mb-2">Heat Adaptation Tracker</h1>
        ...
        <div className="mt-8 space-y-6">
          ...
          <div className="bg-white rounded-xl border border-stone-200 p-6">
            <h2 className="text-lg font-semibold text-stone-900 mb-4">Understanding Heat Adaptation</h2>

            <div className="space-y-4 text-sm text-stone-600">
              <div>
                <p className="font-medium text-stone-700 mb-1">What is heat adaptation?</p>
                <p>
              ...
              <div>
                <p className="font-medium text-stone-700 mb-1">Key adaptations include:</p>
              ...
              <div>
                <p className="font-medium text-stone-700 mb-1">How we calculate your score:</p>
                <ul className="list-disc list-inside ml-2 space-y-1">
