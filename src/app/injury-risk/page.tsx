  ...
  return (
    <div className="min-h-screen bg-stone-50 py-6">
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-stone-900 mb-2">Injury Risk Assessment</h1>
        ...
        <div className="bg-white rounded-xl border border-stone-200 p-6 shadow-sm">
          ...
          <div className="space-y-4 text-stone-600">
            <section>
              <h3 className="font-medium text-stone-800 mb-2">Risk Factors We Monitor</h3>
            ...
            <section>
              <h3 className="font-medium text-stone-800 mb-2">Risk Levels Explained</h3>
            ...
            <section>
              <h3 className="font-medium text-stone-800 mb-2">Prevention Tips</h3>
              <ul className="space-y-1 text-sm">
