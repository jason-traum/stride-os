  ...
  return (
    <div className="min-h-screen bg-stone-50 py-6">
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-stone-900 mb-2">Performance Trends</h1>
        ...
        <div className="space-y-6">
          <div>
            <h2 className="text-lg font-semibold text-stone-800 mb-3">Weekly Overview</h2>
            <PerformanceTrendsCard data={weekTrends} />
          </div>

          <div>
            <h2 className="text-lg font-semibold text-stone-800 mb-3">Monthly Progress</h2>
            <PerformanceTrendsCard data={monthTrends} />
          </div>

          <div>
            <h2 className="text-lg font-semibold text-stone-800 mb-3">Quarterly Analysis</h2>
        ...
        <div className="mt-8 bg-white rounded-xl border border-stone-200 p-6 shadow-sm">
          ...
          <div className="space-y-4 text-stone-600">
            <section>
              <h3 className="font-medium text-stone-800 mb-2">Key Metrics Explained</h3>
            ...
            <section>
              <h3 className="font-medium text-stone-800 mb-2">Reading the Trends</h3>
            ...
            <section>
              <h3 className="font-medium text-stone-800 mb-2">Common Patterns</h3>
