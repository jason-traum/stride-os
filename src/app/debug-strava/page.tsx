  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white p-6 rounded-lg shadow space-y-4">
        <div>
          <h3 className="font-semibold text-sm text-stone-600">Current Origin:</h3>
          <code className="block bg-stone-100 p-2 rounded mt-1">{origin}</code>
        </div>

        <div>
          <h3 className="font-semibold text-sm text-stone-600">Redirect URI being sent:</h3>
          <code className="block bg-stone-100 p-2 rounded mt-1 break-all">{redirectUri}</code>
        </div>

        <div>
          <h3 className="font-semibold text-sm text-stone-600">Full Auth URL:</h3>
          <code className="block bg-stone-100 p-2 rounded mt-1 text-xs break-all">{authUrl}</code>
        </div>

        <div className="pt-4 border-t">
          <h3 className="font-semibold text-sm text-stone-600 mb-2">What to add to Strava App Settings:</h3>
          <p className="text-sm text-stone-700">In your Strava app's "Authorization Callback Domain" field, make sure you have:</p>
        ...
        <div className="pt-4 border-t">
          <h3 className="font-semibold text-sm text-stone-600 mb-2">Test Connection:</h3>
          <a
            href={authUrl}
