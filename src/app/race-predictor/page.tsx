    ...
    <div className="min-h-screen bg-stone-50">
      <div className="mx-auto max-w-4xl p-4 sm:p-6">
        ...
        <div className="mb-6">
          ...
          <h1 className="text-3xl font-bold text-stone-900 mb-2">Race Predictor</h1>
        ...
        <div className="mt-8 bg-white rounded-xl border border-stone-200 p-6 space-y-4">
          <h2 className="text-lg font-semibold text-stone-900">How Predictions Work</h2>

          <div className="space-y-3 text-sm text-stone-600">
            <div>
              <p className="font-medium text-stone-700 mb-1">🏃 Recent Race Performance</p>
