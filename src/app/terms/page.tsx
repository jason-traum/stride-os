    ...
    <div className="max-w-3xl mx-auto space-y-6 py-6">
      ...
      <section className="space-y-2 text-sm text-textSecondary">
        ...
        <p>
          ...
          request account/profile data deletion at <a className="text-[#FC4C02] underline" href="mailto:jason@getdreamy.run">jason@getdreamy.run</a>.
        </p>
      </section>
      ...
      <section className="space-y-2 text-sm text-textSecondary">
        ...
        <p>
          Terms questions: <a className="text-[#FC4C02] underline" href="mailto:jason@getdreamy.run">jason@getdreamy.run</a>
        </p>
      </section>
    </div>
  );
