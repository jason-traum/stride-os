    ...
    <div className="max-w-3xl mx-auto space-y-6 py-6">
      ...
      <section className="space-y-2 text-sm text-textSecondary">
        ...
        <p>
          ...
          data by contacting <a className="text-[#FC4C02] underline" href="mailto:support@getdreamy.run">support@getdreamy.run</a>.
        </p>
      </section>
      ...
      <section className="space-y-2 text-sm text-textSecondary">
        ...
        <p>
          Privacy questions: <a className="text-[#FC4C02] underline" href="mailto:support@getdreamy.run">support@getdreamy.run</a>
        </p>
      </section>
    </div>
  );
