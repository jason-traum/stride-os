...
/** Compute weather pace adjustment (seconds/mile) — simplified inline version */
function getWeatherAdj(tempF: number | null, humidity: number | null): number {
  ...
  if (tempF > 65 && humidity > 40) {
    // Simplified heat index
    effectiveTemp = -42.379 + 2.04901523 * tempF + 10.14333127 * humidity
  ...
  if (effectiveTemp > 55) {
    if (effectiveTemp > 70) {
      adj += (effectiveTemp - 70) * 1.5;
      if (effectiveTemp > 85) adj += (effectiveTemp - 85) * 2.0;
      if (effectiveTemp > 95) adj += (effectiveTemp - 95) * 2.5;
    } else {
      adj += (effectiveTemp - 55) * 0.5;
    }
  } else if (tempF < 40) {
    adj += (40 - tempF) * 0.2;
  }
