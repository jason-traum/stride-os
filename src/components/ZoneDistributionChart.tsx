...
const PACE_ZONES = [
  ...
  { zone: 3, name: 'Steady', color: 'bg-teal-400 dark:bg-teal-500', textColor: 'text-teal-700 dark:text-teal-300' },
  { zone: 4, name: 'Threshold', color: 'bg-rose-600 dark:bg-rose-700', textColor: 'text-rose-700 dark:text-rose-300' },
  { zone: 5, name: 'VO2max', color: 'bg-orange-500 dark:bg-orange-600', textColor: 'text-orange-700 dark:text-orange-300' },
