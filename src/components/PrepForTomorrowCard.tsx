    ...
    return (
      <div className="bg-gradient-to-br from-slate-50 to-slate-100 rounded-xl border border-slate-200 p-5">
        <div className="flex items-center gap-3 mb-3">
          ...
          <div>
            <h3 className="font-semibold text-slate-900">Tomorrow: {data.day}</h3>
    ...
    <div className="bg-gradient-to-br from-indigo-50 to-purple-50 rounded-xl border border-indigo-100 overflow-hidden">
      ...
      <div className="p-5 space-y-5">
        ...
        <div className="bg-white rounded-xl p-4 shadow-sm">
          <h4 className="font-semibold text-slate-900 mb-1">{data.workout.name}</h4>
          <div className="flex items-center gap-3 text-sm text-slate-600">
            ...
            <span className="capitalize text-slate-400">{data.workout.type}</span>
          </div>
        </div>
        ...
        <div>
          <div className="flex items-center gap-2 mb-2">
            ...
            <h4 className="font-medium text-slate-700 text-sm">Tonight</h4>
          </div>
        ...
        {gearItems.length > 0 && (
          <div>
            <div className="flex items-center gap-2 mb-2">
              ...
              <h4 className="font-medium text-slate-700 text-sm">Gear Checklist</h4>
            </div>
        ...
        <div>
          <div className="flex items-center gap-2 mb-2">
            ...
            <h4 className="font-medium text-slate-700 text-sm">Morning</h4>
          </div>
