...
import { Shirt, ThermometerSun, ChevronDown, ChevronUp, Wind, Droplets } from 'lucide-react';
  ...
  return (
    <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
      ...
      <div className="px-4 py-3 bg-gradient-to-r from-orange-50 to-amber-50 border-b border-orange-100">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <h3 className="font-semibold text-slate-900">What to Wear</h3>
          </div>
          <div className="flex items-center gap-2">
      ...
      <div className="px-4 py-3 bg-slate-50 border-b border-slate-100">
        ...
        <p className="text-xs text-slate-500 mt-1">{vt.breakdown}</p>
      </div>
