      ...
      <div className="px-4 py-3 bg-surface-2 border-b border-default">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 bg-dream-900/40 rounded-full flex items-center justify-center">
        ...
        <button
          ...
          className={cn(
            ...
            activeTab === 'outfit'
              ? 'text-dream-600 border-b-2 border-dream-600 bg-bgTertiary/50'
              : 'text-textSecondary hover:text-primary hover:bg-bgTertiary',
            isCold && 'text-dream-600'
          )}
        >
          <span className="flex items-center justify-center gap-1.5">
            <Shirt className="w-4 h-4" />
            Outfit {isCold && <span className="w-1.5 h-1.5 bg-dream-500 rounded-full" />}
          </span>
        </button>
      </div>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              {isMild && !needsPaceAdjustment ? (
                <div className="p-3 bg-emerald-900/30 rounded-lg text-left">
                  <p className="text-xs font-medium text-emerald-400 mb-1">Pace</p>
                  <p className="text-sm font-medium text-emerald-300">No adjustment needed</p>
                  <p className="text-xs text-emerald-400">Great running weather!</p>
                </div>
              ) : paceAdjustment && (
                <button
                  onClick={() => setActiveTab('pace')}
            ...
            {paceAdjustment && paceAdjustment.warnings.length > 0 && (
              <div className="space-y-2">
                {paceAdjustment.warnings.slice(0, 1).map((warning, i) => (
                  <div key={i} className="flex items-start gap-2 text-rose-400 bg-rose-900/30 p-2 rounded-lg">
          ...
          <div className="space-y-4">
            ...
            {isMild && !needsPaceAdjustment && (
              <div className="bg-emerald-900/30 rounded-lg p-4 text-center">
                <p className="text-emerald-300 font-medium">Great running weather!</p>
                ...
                <div className="pt-2 border-t border-borderSecondary">
                  <div className="flex flex-wrap gap-2">
                    {recommendation.addOns.shell && (
                      <span className="px-2 py-1 bg-dream-900/30 text-dream-300 text-xs rounded-full">
                        + Shell
                      </span>
                    )}
          ...
          <div className="bg-bgSecondary rounded-xl max-w-sm w-full p-5 shadow-xl" onClick={e => e.stopPropagation()}>
            ...
            <div className="space-y-2 text-xs text-textSecondary">
              ...
              <div className="grid grid-cols-2 gap-2">
                ...
                <div className="bg-sky-900/30 p-2 rounded"><span className="font-medium">20-35°</span><br/>Layer up</div>
                <div className="bg-green-950 p-2 rounded"><span className="font-medium">35-50°</span><br/>Light layers</div>
                <div className="bg-rose-900/30 p-2 rounded"><span className="font-medium">50+°</span><br/>Minimal</div>
              </div>
            </div>
          </div>
        </div>
